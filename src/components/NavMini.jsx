    ...
    <div id="navmini" className="position-relative">
      ...
      <div className="position-absolute nav-position">
        <Nav className="flex-column ">
          <NavLink to="/about/controlling" className="nav-link">
            Контролирующие органы
          </NavLink>
          <NavLink to="/about/licenses" className="nav-link">
            Лицензии
          </NavLink>
          <NavLink to="/about/documents" className="nav-link">
            Документы
          </NavLink>
          <NavLink to="/about/partners" className="nav-link">
            Наши партнеры
          </NavLink>
        </Nav>
      </div>

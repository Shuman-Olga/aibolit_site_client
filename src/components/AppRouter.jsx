...
const publicRoutes = [
  ...
  { path: '/about/controlling/', Component: ControllingOrgan },
  ...
  { path: '/programs/malysh-houm-standart/', Component: ProgramOne },
  { path: '/programs/zdorovyj-rebenok-houm-standart/', Component: ProgramTwo },
  { path: '/programs/zdorovyj-rebenok-houm-midi/', Component: ProgramThree },

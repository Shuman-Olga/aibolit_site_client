  ...
  return (
    <Container fluid id="santornokurortnyakarta">
      ...
      <Container>
        ...
        <BlockReklama1 />
        <div>
          <h5>Что нужно для получения санаторно-курортной карты для детей:</h5>
          <ul>
            <li>
            ...
            <li>справка об инвалидности(если ребенок – инвалид) и СНИЛС. ​</li>
          </ul>
          <h5>Информация для сопровождающих</h5>
          <p>
            Иногда вместе с ребенком, проходящим санаторно-курортное лечение или
            реабилитацию, должны или желают находиться родители (опекуны). В
            этом случае взрослые тоже проходят врачебный осмотр и получают
          ...
          <ul>
            ...
            <li>полис ОМС;</li>
            <li>
              справку от дерматолога, подтверждающую отсутствие кожных инфекций;
            </li>
            <li>
          ...
          <p>
            Длительность нахождения ребенка в лечебно-оздоровительном учреждении
            обычно составляет 21 день, иногда – 40 дней. В некоторых случаях
            срок лечения продлевают «на месте», если врачи считают, что ребенку
            это необходимо. Для составления и принятия акта о продлении лечения
            созывается КЭК (клинико-экспертная комиссия).
          </p>
          <p>
            Перед отправлением ребенка в санаторий для лечения либо
            профилактики, обязательно нужно проконсультироваться с врачом. Смена
            климата, высоты над уровнем моря и другие факторы могут значительно
            повлиять на самочувствие
          </p>
          <h5>Есть ли противопоказания?</h5>
          <p>
            Да, существует ряд болезней и состояний, которые могут быть выявлены
            в ходе оформления санаторно-курортной карты по форме №076/у-04 и
            являются противопоказаниями для лечебно-профилактических
            мероприятий: ​
          </p>
          <ul>
          ...
          <table class="table table-light table-striped text-start ">
            ...
            <tbody>
              <tr>
                <td className="px-3">
                  <p className="ms-5">
                    Оформление санаторно-курортная карта (форма №076/у-04) (ПРИ
                    НАЛИЧИИ АНАЛИЗОВ, годны в течении 10 дней)
                  </p>
                </td>
                <td>
                  <p>1 500 руб.</p>
...
export default SanatornoKurortnayaKarta;

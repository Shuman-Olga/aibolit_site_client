  ...
  return (
    <Container id="post" className="d-flex justify-content-center">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="вызов лор на дом, вызов невролога на дом, педиатр на дом, вызов хирурга на дом, вызов платного педиатра, хируг детский на дом, патронаж новорожденного"
        />
        <link
          rel="canonical"
      ...
      <div className="size-cont border mb-4">
        ...
        <p align="justify">
          ...
          развития, требующих оперативного хирургического вмешательства, у детей
          и подростков. Осмотр хирурга требуется для новорожденного малыша,
          чтобы исключить или выявить врожденные аномалии и пороки развития,
          грыжи (паховые, пупочные, белой линии живота), проблемы паховых
          органов (неопущение или перекрут яичка, водянка яичка, варикоцеле). В
          течение жизни ребенка хирург наблюдает за правильным формированием
          организма, оказывает помощь при гнойных воспалительных заболеваниях,
          травмах и ранениях, проводит хирургическое лечение новообразований,
          сердечнососудистой патологии, ведет послеоперационное наблюдение и
          восстановительное лечение.
        </p>
        <hr />
        <p align="justify">
          <h5>Вызов детского врача-хирурга на дом</h5>
          <br />В детской медицинской службе «АЙБОЛИТ» мы знаем, что самым
          удобным местом для консультаций
        ...
        <p align="justify">
          ...
          />
          Первый{" "}
          <span className="fst-italic">профилактический осмотр у хирурга </span>
          ...
          развития. Однако не все проблемы могут быть выявлены сразу – отдельные
          аномалии развития могут проявиться лишь спустя некоторое время.
          Поэтому на первом году жизни проводится несколько плановых осмотров у
          хирурга, чтобы установить диагноз и провести хирургическое лечение в
          как можно более раннем возрасте, чтобы не допустить развития патологии
          и нарушения нормального развития ребенка. Плановые профилактические
          осмотры хирургом малышей первого года жизни детей производится в 1, 6
          и 12 месяцев.
        </p>
        <br />
        <br />
        ...
        <p align="justify">
          ...
          нарушения целостности органов и тканей, нарушения дыхания и сердечной
          деятельности, сочетания болей в животе с повышением температуры –
        ...
        <p align="justify" className="text-center">
          <span className="fw-bold fst-itali ">
            Детский хирург, консультация на дому --------------------- 2 000 р.*
          </span>
          <br />
          <br />
          <small>
